  ...
  draw(renderer, camera, visualState = {}) {
    renderer.drawPlayerCharacter(
      ...
      this.height,
      {
        ...
        isEnteringPortal: visualState.isEnteringPortal || false,
        portalEnterProgress: visualState.portalEnterProgress || 0,
        portalEnterTarget: visualState.portalEnterTarget || null,
      },
      camera,
    );
  }
